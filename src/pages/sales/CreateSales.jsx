 ...
 // console.log(selectedCustomer);
  ...
  const fetchCustomer = () => {
    axios.get(baseUrl + "/api/Customar/")
      .then(res => {
        // console.log(res);
        setSuppliers(res.data.customar)
      })
  }
  ...
  const handleProcess=()=>{
    setPurchaseProcess({
      supplier_id:selectedCustomer.id,
  ...
  return (
    <div className="container my-5">
      ...
      <div className="card-header bg-info text-white text-left">
          <h1 className="mb-0">Create Sales</h1>
        </div>
        <div className="card-body">
          ...
          <div className="row mb-4">
            ...
            <div className="col-md-4">
              <h5>Supplier</h5>
              <select onChange={handleselectedCustomer} className="form-select mb-2" name="supplier">
              ...
              <p className="mb-1">Email: {selectedCustomer && selectedCustomer.email} <span id="phone"></span></p>
              <p>Address:  {selectedCustomer && selectedCustomer.address} <span id="email"></span></p>
